...
class StudentControllerV5Test {
    
    @LocalServerPort
    private String port;
    
    @Autowired
    private StudentControllerV5 studentController;
    ...
    void create_student_endpoint_test(){
        StudentV5 student = new StudentV5();
        student.setAge(20);
    ...
    void update_student_endpoint_test(){
        ...
        RequestEntity<StudentV5> requestEntity = new RequestEntity<>(student, HttpMethod.PUT,
