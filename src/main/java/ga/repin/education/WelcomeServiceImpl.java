...
public class WelcomeServiceImpl implements WelcomeService {
    ...
    public String operationIndex() {
        ...
        return mainTheme("Demo service selection: "
                ...
                hrefPrep("/calculator",
                        "2.3 CALCULATOR TASK") +
                commentPrep(hwCaption("2.3. Introduction to Maven and Spring Boot",
                        true, "16833", 16), null)
                + "<a href=\"/auth\">2.4 CHECKING AUTH FIELDS TASK</a>"
                + commentPrep(hwCaption("2.4. Working with exceptions", true, "16834", 17), null)
                + "<a href=\"/employee\">2.5 V1 API EMPLOYEE DEV (interface List)</a>"
                + commentPrep(hwCaption("2.5. Collections and sets", true, "16835", 18), null)
                + "<a href=\"/v2/employee\">2.7 V2 API EMPLOYEE DEV (interface Map)</a>"
                + commentPrep(hwCaption("2.7. Collections: variety of implementations", true, "16837", 20), null)
                + "<a href=\"/v3/employee\">2.8 V3 API EMPLOYEE DEV (Stream API)</a>"
                + commentPrep(hwCaption("2.8. Stream API and Optional", true, "16838", 21), null)
                + "<a href=\"/v4/employee\">2.10 V4 API EMPLOYEE DEV (commons-lang3)</a>"
                + commentPrep(hwCaption("2.10. Libraries", true, "16841", 22), null)
                + hrefPrep(ga.repin.education.course02.topic11.hw.HwConstants
                .HW_ENDPOINT,
                "2.11 API TO PREPARE ORDERS IN SESSION BASKET")+
                commentPrep(hwCaption("2.11. Spring",
                        true, "16842", 23), null)
        );
    }
